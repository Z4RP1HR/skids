...
while attemps < 150:
    ...
    if username == 'skid' and password == 'skid':
...
def title():
   ...
   _____ _  _______ _____   _____ ______ _____ 
  / ____| |/ /_   _|  __ \ / ____|  ____/ ____|
 | (___ | ' /  | | | |  | | (___ | |__ | |     
  \___ \|  <   | | | |  | |\___ \|  __|| |     
  ____) | . \ _| |_| |__| |____) | |___| |____ 
 |_____/|_|\_\_____|_____/|_____/|______\_____| VERSION 1.4 """)                                                                                                                                                                                                                                                                      
    stdout.write("             "+Fore.LIGHTRED_EX            +"        ══╦═════════════════════════════════╦══\n")
    stdout.write("             "+Fore.LIGHTRED_EX+"╔═════════╩═════════════════════════════════╩═════════╗\n")
    stdout.write("             "+Fore.LIGHTRED_EX+"║ "+Fore.LIGHTWHITE_EX   +"    FB Page : https://facebook.com/skidsechackers  "+Fore.LIGHTRED_EX  +" ║\n")
    stdout.write("             "+Fore.LIGHTRED_EX+"║ "+Fore.LIGHTWHITE_EX   +"    Copyright : SKIDSEC PHILIPPINES   "+Fore.LIGHTRED_EX  +"              ║\n")
...
##############################################################################################
def command():
    stdout.write(Fore.LIGHTRED_EX+"╔═══"+Fore.LIGHTRED_EX+"[""Skidsec"+Fore.LIGHTRED_EX+"@"+Fore.LIGHTRED_EX+"Ph"+Fore.CYAN+"]"+Fore.LIGHTRED_EX+"\n╚══\x1b[38;2;0;255;189m> "+Fore.WHITE)
    command = input()
